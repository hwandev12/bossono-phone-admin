...
(function() {
  ...
  "undefined" === typeof Chart ? console.warn("Can not find Chart object.") : (c.prototype.beforeDatasetsUpdate = function(a) {
      ...
      if (0 !== d.circumference || this.showZero) {
        switch (this.render) {
          ...
          default:
            ...
            this.showActualPercentages || (h += q, 100 < h && (q -= h - 100, q = parseFloat(q.toFixed(this.precision))));
            e = q + "%"
        }
        ...
        if ("outside" === this.position || "border" === this.position && "pie" === p.config.type) {
          ...
          "border" === this.position ? c = (d.outerRadius -
            k) / 2 + k : "outside" === this.position && (c = d.outerRadius - k + k + m);
          n = {
            x: d.x + Math.cos(n) * c,
            y: d.y + Math.sin(n) * c
          };
        ...
        if (this.arc) r || (r = (k + d.outerRadius) / 2), b.fillStyle =
          m, b.textBaseline = "middle", this.drawArcText(e, r, d, this.overlap);
        else {
    ...
    return b ? (this.chartInstance = a, this.ctx = a.chart.ctx, this.options = a.config.options, this.render =
    ...
    for (var h = this.labelBounds, f = 0; f < h.length; ++f) {
      for (var g = h[f], d = [
        ...
        var c = d[e][0],
          k = d[e][1];
        if (c >= g.left && c <= g.right && k >= g.top && k <= g.bottom) return !1
      }
      d = [
        [g.left, g.top],
        [g.left, g.bottom],
      ...
      for (e = 0; e < d.length; ++e)
        if (c = d[e][0], k = d[e][1], c >= a && c <= b && k >= p && k <= l) return !1
    }
    h.push({
      left: a,
      right: b,
    ...
    var c = this.ctx;
    "object" === typeof a ? c.drawImage(a, b.x - a.width / 2, b.y - a.height / 2, a.width, a.height) : (c.fillStyle = p, c.textBaseline = "top", c.textAlign = "center", c.fillText(a, b.x, b.y - this.fontSize / 2))
    ...
    if (l || !(c - d > g))
      if ("string" === typeof a)
        for (h.rotate(d), l = 0; l < a.length; l++) d = a.charAt(l), f = h.measureText(d), h.save(), h.translate(0, -1 * b), h.fillText(d, 0, 0), h.restore(), h.rotate(f.width / b);
      else h.rotate((e + c) / 2), h.translate(0, -1 * b), this.fillText(a, {
        x: 0,
        y: 0
      });
    h.restore()
